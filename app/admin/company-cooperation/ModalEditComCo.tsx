...
import { useUpdateCoworkMutation } from "@/redux/features/cowork/coworkApi";
...
export default function ModalEditComCo({ data, refetch }: any) {
  ...
  const payloadInitial = {
    ...
    mainCoordinator: data.mainCoordinator,
    posisionCoordinator: data.posisionCoordinator,
    lineIdCoordinator: data.lineIdCoordinator,
    phoneNumberCoordinator: data.phoneNumberCoordinator,
    emailCoordinator: data.emailCoordinator,
    dateStartCoperation: data.dateStartCoperation,
    dateEndCoperation: data.dateEndCoperation,
    detailMOU: data.detailMOU,
    file: "",
    note: data.note,
    statusCoperation: data.statusCoperation,
    typeOfCoperation: data.typeOfCoperation,
  ...
  const [updateCowork, { isLoading, error, isSuccess }] =
    useUpdateCoworkMutation();

  useEffect(() => {
    if (isSuccess) {
      toast.success("อัพเดทความร่วมมือเรียบร้อยแล้ว");
      refetch();
      setOpenModal(false);
    }
    if (error) {
      toast.error("อัพเดทความร่วมมือผิดพลาด");
    }
  }, [error, isSuccess]);
  ...
  const handleSubmit = async () => {
    await updateCowork({ id: data?._id, data: payload });
  };
  ...
  return (
    <>
      <Button onClick={() => setOpenModal(true)} outline color="warning">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <TextInput
                  ...
                  type="text"
                  value={payload.posisionCoordinator}
              ...
              <div>
                ...
                <TextInput
                  ...
                  type="text"
                  value={payload.phoneNumberCoordinator}
              ...
              <div>
                ...
                <TextInput
                  ...
                  type="text"
                  value={payload.lineIdCoordinator}
              ...
              <div>
                ...
                <TextInput
                  id="emailCoordinator"
                  type="text"
                  value={payload.emailCoordinator}
              ...
              <div>
                ...
                <Datepicker
                  ...
                  required
                  value={payload.dateStartCoperation}
              ...
              <div>
                ...
                <Datepicker
                  ...
                  placeholder="วันที่เริ่มทำข้อตกลงความร่วมมือ"
                  required
                  value={payload.dateEndCoperation}
                  onSelectedDateChanged={(date) =>
